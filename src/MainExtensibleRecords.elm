...
normaliseDeclarations nodeDeclaration normalisedDeclarationsWithIdentifierMapping =
    let
        declaration = Node.value nodeDeclaration
        normalizedDeclarationWithIdentifierMapping = normaliseDeclaration normalisedDeclarationsWithIdentifierMapping.identifierMapping declaration 
        normalizedNodeDeclaration = Node.map (\_ -> normalizedDeclarationWithIdentifierMapping.declaration) nodeDeclaration
    in
...
normaliseTypeAlias unNormalizedTypeAliasWithIdentifierMapping =
    let
        typeAlias = unNormalizedTypeAliasWithIdentifierMapping.typeAlias
        ...
        , declaration = 
            Declaration.AliasDeclaration
                (TypeAlias
                    ...
                    typeAlias.generics -- want to normalise this, removed to create simple case to compare approaches
...
normaliseString unNormalisedWithIdentifierMapping =
    let
        identifierMapping = unNormalisedWithIdentifierMapping.identifierMapping
        unNormalisedNodeString = unNormalisedWithIdentifierMapping.nodeString
        normalisedString = "IDENTIFIER_" ++ String.fromInt identifierMapping.uniqueInt
        nextIdentifierMapping = Dict.insert (Node.value unNormalisedNodeString) normalisedString identifierMapping.mapping
    in
