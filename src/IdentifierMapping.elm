module IdentifierMapping exposing (WithIdentifierMapping, initialize, normalise, normaliseString, map, value)
...
normalise toString fromString (WithIdentifierMapping (IdentifierMapping mapping uniqueInt) unNormalised) =
    let
        ...
        nextIdentifierMapping = Dict.insert (toString unNormalised) normalised mapping
    in
        WithIdentifierMapping
            ( IdentifierMapping 
                nextIdentifierMapping 
...
normaliseString (WithIdentifierMapping (IdentifierMapping mapping uniqueInt) unNormalised) =
    let
        normalised = "IDENTIFIER_" ++ String.fromInt uniqueInt
        nextIdentifierMapping = Dict.insert unNormalised normalised mapping
    in
        WithIdentifierMapping
            ( IdentifierMapping 
                nextIdentifierMapping 
